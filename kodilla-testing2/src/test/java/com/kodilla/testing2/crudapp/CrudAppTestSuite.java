...
public class CrudAppTestSuite {
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
       ...
       driverTrello.findElement(By.id("password")).sendKeys("elBgJqn0j@Tv!8");
        ...
        driver.findElements(
                ...
                .filter(anyForm ->
                        anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
                                .getText().equals(taskName))
                .forEach(theForm -> {
                    theForm.findElement(By.xpath(".//div[contains(@action,\"createTask\")]/fieldset[1]/button[4]"))
                            .click();
                });
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        String taskTrello = createCrudAppTestTask();
        sendTestTaskToTrello(taskTrello);
        assertTrue(checkTaskExistsInTrello(taskTrello));
        deleteFromTaskCrud(taskTrello);
    }
